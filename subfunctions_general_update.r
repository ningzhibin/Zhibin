...
# 20190310: add a function to calculate the fold change between any two groups of columns, similar to  
# 20181129: add a function quantile_normalisation to do quantile normailization on a data.frame, columnmise
# 20181002: add a line to replace the infinite values, heatmap.2 can deal with NA, but not infinte values
...
#this function is simliar to the matrix_ttest
# input: data.matrix ,grouping string, and two separate groups
...
####
# functiom to do quantile normalization 
# code copied from https://davetang.org/muse/2014/07/07/quantile-normalisation-in-r/
